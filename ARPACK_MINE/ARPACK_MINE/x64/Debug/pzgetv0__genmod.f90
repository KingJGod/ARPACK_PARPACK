        !COMPILER-GENERATED INTERFACE MODULE: Thu Jun 21 16:39:11 2018
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE PZGETV0__genmod
          INTERFACE 
            SUBROUTINE PZGETV0(COMM,IDO,BMAT,ITRY,INITV,N,J,V,LDV,RESID,&
     &RNORM,IPNTR,WORKD,WORKL,IERR)
